...
class TestFuelType:
    def test_grass_spread_rate(self) -> None:
        assert FuelType.GRASS.base_spread_rate == pytest.approx(1.0)

    def test_barren_no_spread(self) -> None:
        assert FuelType.BARREN.base_spread_rate == pytest.approx(0.0)

    def test_timber_highest_intensity(self) -> None:
        assert FuelType.TIMBER.base_intensity == pytest.approx(1.0)

    def test_barren_no_intensity(self) -> None:
        assert FuelType.BARREN.base_intensity == pytest.approx(0.0)
...
class TestFuelCell:
    ...
    def test_spread_modifier_wet(self) -> None:
        ...
        assert cell.spread_modifier == pytest.approx(0.0)
    ...
    def test_barren_no_spread(self) -> None:
        ...
        assert cell.spread_modifier == pytest.approx(0.0)
        assert cell.intensity_modifier == pytest.approx(0.0)
